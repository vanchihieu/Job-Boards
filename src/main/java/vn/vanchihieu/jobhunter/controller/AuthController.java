...
import vn.vanchihieu.jobhunter.domain.request.ReqLoginDTO;
import vn.vanchihieu.jobhunter.domain.response.ResCreateUserDTO;
import vn.vanchihieu.jobhunter.domain.response.ResLoginDTO;
...
public class AuthController {
    ...
    public ResponseEntity<ResLoginDTO> getRefreshToken(
            @CookieValue(name = "refresh_token", defaultValue = "abc") String refresh_token) throws IdInvalidException { // @CookieValue: lấy giá trị từ cookie
